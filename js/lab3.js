window.addEventListener('load', function (event) {
    ...
    let detj = document.getElementById('detj');
    ...
    detj.addEventListener('click', function (event) {
        exportToJSON();
    })
    ...
    // Draw Triangle
    let dt = document.getElementById('dt'); //Button
    dt.addEventListener('click', function (event) {
        drawT();
    });
    let ddt = document.getElementById('ddt');//Dropdown button
    ddt.addEventListener('click', function (event) {
        drawT();
    });
    ...
    // Draw Rectangle
    let dr = document.getElementById('dr');//Button
    dr.addEventListener('click', function (event) {
        drawR();
    });
    let ddr = document.getElementById('ddr');//Dropdown Button
    ddr.addEventListener('click', function (event) {
        drawR();
    });
    ...
    ddc.addEventListener('click', function (event) {
        drawC();
    });
    ...
    let dcc = document.getElementById('dcc');
